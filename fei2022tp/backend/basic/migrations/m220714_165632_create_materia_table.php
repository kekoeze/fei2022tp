 ...
 * - `{{%id_profesor}}`
 */
class m220714_165632_create_materia_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        // add foreign key for table `{{%id_carrera}}`
        $this->addForeignKey(
        ...
        // add foreign key for table `{{%id_profesor}}`
        $this->addForeignKey(
    ...
    {
        // drops foreign key for table `{{%id_carrera}}`
        $this->dropForeignKey(
            '{{%fk-materia-id_carrera}}',
            '{{%materia}}'
        );
        ...
        // drops foreign key for table `{{%id_profesor}}`
        $this->dropForeignKey(
            '{{%fk-materia-id_profesor}}',
            '{{%materia}}'
        );
